...
//Strona z kontem użytkownika zalogowanego
...
?>
    ...
    <!--Formularz pokazujący dane i z pożliwością do modyfikacji-->
    <script>document.title = "Konto";</script>
    <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
            <div class="card-body p-4 p-sm-5">
                <h3 class="card-title text-center mb-5 fw-light fs-10 fw-bold">
                    Twoje Konto
                </h3>
                        ...
                        <div class="container mt-4 mb-4">
                            <div class="row text-center">
                                <div class="col-12 col-md-6">
                                    <button type="submit" class="btn btn-lg btn-primary" name="modify"
                                            value="<?php echo $row['users_id']
                                            ?>">Modyfikuj Konto
                                    </button>
                                </div>
                                <div class="col-12 p-5 p-md-0 col-md-6">
                                    <button type="submit" class="btn btn-lg btn-danger" name="passw"
                                            value="<?php echo $row['users_id']
                                            ?>">Zmień Hasło
                                    </button>
                                </div>
